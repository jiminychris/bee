...
(setq casey-todo-file (substitute-env-vars "$PROJECT_ROOT/code/todo.txt"))
(setq casey-log-file (substitute-env-vars "$PROJECT_ROOT/code/log.txt"))
...
; JS mode handling
(defun chris-big-fun-js-hook ()
  (setq js-switch-indent-offset js-indent-level)
  ; 4-space tabs
)

(add-hook 'js-mode-hook 'chris-big-fun-js-hook)
